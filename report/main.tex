...
\begin{figure}[Hh!]
    ...
    \bitbox{8}{CRC-8}
	\end{bytefield}
  \caption{ZACwire Transmission structure of data, which is sent out from the hymidity board. The two bits, marked with gray color, before the temperature value are undefined. ST represents the start bit.}
