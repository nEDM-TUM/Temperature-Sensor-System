...
experiment was able to do measurement more precise than $10^{-26}e\cdot cm$\cite{frmexp}.\\
...
Besides an exact defined magnetic environment inside the experiment setup, a well defined
...
As a precise homogenous temperature distribution inside the whole field cage however is
almost impossible to achieve. Therefore our sensor network will provide useful data
with sufficient precision to analyze, if specific physical observations are dependant
...
%###############################################################
\chapter{Technology}
In this chapter, we will introduce shortly the mainly used technologies, like chosen sensors, data transmission protocols, as well as
the used tools for the development, 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In this capital, 
we will describe the logical design of the whole system and the hardware/sofware implementation details of the tree types of boards.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a system reset will occur. This approach may also handle can only be seen as a temporary solution, as
