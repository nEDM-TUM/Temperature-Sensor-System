...
%FIXME foto of the finish soldered board
...
Then the result attached the rest unchanged input bits becomes new input and do the same XOR calculation with the divisor again and again, until no rest bits any more to attach and the n bits remainder is the to computed CRC checksum.
...
\begin{figure}[Hh!]
	\centering
	\includegraphics[width=\textwidth]{img/boards/collector_kicad.pdf}
...
\begin{figure}[Hh!]
	...
	\label{fig:pcb_arduino} %FIXME: add reference in text
\end{figure}
