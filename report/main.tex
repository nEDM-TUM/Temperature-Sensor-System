...
After data was received via the ZAC-Wire protocol, it is interpreted and converted to a convenient packet format, suitable for redirection via I2C. The packet's integrity is protected, using a CRC-8 checksum.
