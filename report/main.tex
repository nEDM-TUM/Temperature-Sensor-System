...
\begin{table}[Hh!]
    ...
    Name & Value & Parameters & Action\\
		\hline
		\hline
    START\_MEASUREMENT & 0x01 & --- & All 8 sensor values will be captured and converted into a ready to send packet array.\\
		\hline
...
After data was received via the ZAC-Wire protocol, it is interpreted and converted to a convenient packet, suitable for redirection via I2C.
