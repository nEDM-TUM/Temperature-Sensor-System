...
by IST AG. Only one data line is needed. Bits are represented by
...
shows the four different wafeform types, a ZACwire signal may be
...
\begin{table}[Hh!]
	...
	\begin{tabularx}{\textwidth}{ | c | c | c | X | }
		\hline
    Name & Parameters format &Parameters & Action\\
		\hline
		\hline
