...
%FIXME add reference to humidity packet structur image
...
the TSIC sensor, as well as the humidity board start the transmission with a 0 bit (see figure \ref{fig:tsic_transmission} and \ref{FIXME}). Hence, if we see a
