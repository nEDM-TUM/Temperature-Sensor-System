...
But the timing of this method is not very exact (more than 6 $\mus$ inaccuracy according to experience). Hence we decided to use a timer to achieve a higher timing accuracy. \\
